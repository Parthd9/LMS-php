...
{
 Global $servername,$username,$password,$conn,$db,$uname,$pass;
 $sql="SELECT * from userdetail where uname = '$arg1' AND u_password='$arg2';";
Echo $sql;
...
if(empty($uname))
{
	$unameerr="uname can't be empty";
	echo "uname can't be empty";
}
...
if($nameerr=="" && $cityerr=="" && $passerr1=="" && $passerr2=="")
{
    ...
    $sql = "INSERT INTO userdetail(uname,name,u_email,u_address,u_password) VALUES('$uname','$name','$email','$city','$psw');";
